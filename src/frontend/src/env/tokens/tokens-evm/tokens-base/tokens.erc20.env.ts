...
import { EURC_TOKEN, SEPOLIA_EURC_TOKEN } from '$env/tokens/tokens-evm/tokens-base/tokens-erc20/tokens.eurc.env';
import { SPX_TOKEN } from '$env/tokens/tokens-evm/tokens-base/tokens-erc20/tokens.spx.env';
import { SEPOLIA_USDC_TOKEN, USDC_TOKEN } from '$env/tokens/tokens-evm/tokens-base/tokens-erc20/tokens.usdc.env';
